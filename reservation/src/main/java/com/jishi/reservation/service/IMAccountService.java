...
public class IMAccountService {
    ...
    /**
     * @description 获取普通用户im的token，没有im账户则创建，没有token则更新
     * @param accId 用户id
     * @throws Exception
    **/
    public String getUserToken(Long accId) throws Exception {
        ...
        if (imAccount == null) {
            ...
            return refreshUserToken(accId);
        }
        log.info("用户accId：" + accId + " im token" + imAccount.getImToken());
        return imAccount.getImToken();
    }

    /**
     * @description 获取医生im的token，没有im账户则创建，没有token则更新
     * @param doctorId 本地系统医生id
     * @throws Exception
    **/
    public String getDoctorToken(Long doctorId) throws Exception {
        ...
        if (imAccount == null) {
            ...
            return refreshDoctorToken(doctorId);
        }
    ...
    **/
     ...
     * @throws
     **/
    public String createUserByAccountId(Long accId) throws Exception {
     ...
     * @throws Exception
     **/
    public String createUserByDoctorId(Long doctorId) throws Exception {
     ...
     * @throws Exception
     **/
    public String createUserByDoctorHisId(String doctorHisId) throws Exception {
     ...
     * @throws Exception
    **/
    private String createUser(Long accId, Long doctorId, String doctorHisId) throws Exception {
        if (accId == null && doctorId == null && Helpers.isNullOrEmpty(doctorHisId)) {
            log.error("accId doctorId doctorHisId不能全为空");
            return null;
        }

        IMAccount imMUser = new IMAccount();
        ...
        imMUser.setImAccId(resUser.getAccid());
        imMUser.setImToken(resUser.getToken());
        imAccountMapper.insert(imMUser);

        return resUser.getToken();
    }
}
