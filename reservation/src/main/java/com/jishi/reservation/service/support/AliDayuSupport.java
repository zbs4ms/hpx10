...
public class AliDayuSupport {
    ...
    public void sendynamicCode(String phone, String code ,String templateCode) throws Exception{
        ...
        IClientProfile profile = DefaultProfile.getProfile(Common.REGION_ID, Common.ACCESS_KEY_ID,
                Common.ACCESS_KEY_SECRET);
        DefaultProfile.addEndpoint(Common.REGION_ID, Common.REGION_ID, Common.PRODUCT, Common.DOMAIN);
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName(Common.HOSPITAL_NAME);
        //必填:短信模板-可在短信控制台中找到
