...
public class OutpatientController extends MyBaseController {
    ...
    @ResponseBody
    public JSONObject queryOutpatientPamentInfo(Long accountId,
    ...
    @ResponseBody
    public JSONObject generateOrder(Long accountId,
    ...
    @ResponseBody
    public JSONObject payModify(Long accountId,
    ...
    @ResponseBody
    public JSONObject outpatientPaymentConfirm(Long accountId,
                @ApiParam(value = "订单号", required = true) @RequestParam(value = "orderNumber", required = true) String orderNumber) throws Exception {
    ...
    @ResponseBody
    public JSONObject queryVisitRecord(Long accountId,
    ...
    @ResponseBody
    public JSONObject visitReceipt(Long accountId,
    ...
    @ResponseBody
    public JSONObject queryVisitPrescription(Long accountId,
                                           @ApiParam(value = "挂号单号", required = true) @RequestParam(value = "registerNum") String registerNum) throws Exception {
    ...
    @ResponseBody
    public JSONObject visitQueueInfo(Long accountId,
    ...
    @RequestMapping(value="/admin/addDoctorNotifyLength", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value="/admin/addDepartNotifyLength", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value="/admin/updateDoctorNotifyLength", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value="/admin/updateDepartNotifyLength", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value="/admin/queryQueueNotifyLength", method = RequestMethod.GET)
    @ResponseBody
